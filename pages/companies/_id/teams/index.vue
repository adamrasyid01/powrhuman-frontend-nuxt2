  ...
  <div class="lg:pr-[70px] py-[50px] lg:ml-[320px] xl:ml-[365px] px-4 lg:pl-0">
    ...
    <section class="pt-[50px]">
      ...
      <p v-if="$fetchState.pending">Fetching Teams....</p>
        <div v-else class="items-center card py-6 md:!py-10 md:!px-[38px] !gap-y-0" v-for="team in teams" :key="team.id">
          <a
            href="#"
...
export default {
  ...
  async fetch() {
    const response = await this.$axios.get("/team?company_id=" +  this.$route.params.id);

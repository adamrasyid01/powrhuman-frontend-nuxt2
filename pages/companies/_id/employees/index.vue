  ...
  <div class="lg:pr-[70px] py-[50px] lg:ml-[320px] xl:ml-[365px] px-4 lg:pl-0">
    ...
    <section class="pt-[50px]">
      ...
      <p v-if="$fetchState.pending">Fetching employees...</p>
        <!-- Card -->
        <div class="items-center card py-6 md:!py-10 md:!px-[38px] !gap-y-0" v-else v-for="employee in employees" :key="employee.id">
          <a
            href="#"
          ...
          <a href="#verify" v-else  class="text-blue-700 mt-[30px] text-center underline relative z-20">Verify Now</a>
        </div>
      </div>
    </section>
  </div>
...
export default {
 ...
 data() {
  ...
  async fetch() {
    const response = await this.$axios.get("/employee?company_id=" +  1);
